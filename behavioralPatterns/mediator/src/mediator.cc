...
public:
  ...
  FileSelectionDialog(){
    ...
    _components[DirList] = new Edit(this, "dir");
    _components[FileList] = new Edit(this, "file");
...
FileSelectionDialog::~FileSelectionDialog(){
  for (int i = 0; i < 4; i++) {delete _components[i];}
}

void Widget::changed(){ _mediator->widgetChanged(this);}
