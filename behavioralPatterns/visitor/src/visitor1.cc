...
public:
  ...
  virtual void traverse(){cout << value << endl;}
  // Having add() here sacrifies safety, but it supports transparency
...
int main(int argc, char *argv[]) {
  ...
  // nodes[0]->add(nodes[1]);
  // If it is NOT in Component, and only in Composite, you get error -
  // no member function 'Component::add(Component *)' defined
  // Instead of sacraficing safety, we use a Visitor to support add()
